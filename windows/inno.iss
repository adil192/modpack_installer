...
#define MyAppName "adil192's modpack installer"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "Adil Hanney"
#define MyAppURL "https://github.com/adil192modpacks/installer"
#define MyAppExeName "installer.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{3FFF6CB3-D229-400A-B6FE-DC2E082AEB66}
AppName={#MyAppName}
...
OutputBaseFilename=modpack_installer_installer
